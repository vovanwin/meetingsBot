...
// The GatherFunc type is an adapter to allow the use of ordinary
// function as Gather mutator.
type GatherFunc func(context.Context, *gen.GatherMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f GatherFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.GatherMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.GatherMutation", m)
}
...
type VoteFunc func(context.Context, *gen.VoteMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f VoteFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.VoteMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.VoteMutation", m)
}
